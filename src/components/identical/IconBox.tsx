...
const IconBox: React.FC<IconBoxProps> = ({ icon, heading, subheading }) => {
  return (
    <div className="flex w-full flex-col items-center gap-3 rounded-md border border-emerald-500/25 p-4 text-center shadow-lg shadow-emerald-500/50 md:max-w-[300px]">
